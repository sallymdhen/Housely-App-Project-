...
class _DetailsScreenState extends State<DetailsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Details', style: AppTextStyle.locationName.copyWith(fontWeight: FontWeight.w800)),
        actions: [
          SizedBox(width: 27),
    ...
    :
    Image.asset('assets/icons/Heart_grey.png',height:24 ,width:24 ,),
      ...
      body: SafeArea(
        child: Stack(
          children: [Padding(
            padding: EdgeInsetsGeometry.symmetric(horizontal: 24, vertical: 14),
  ...
  child: PageView.builder(
    ...
    itemCount: constantPhotoOfEstate.length + 1, // +1 لصورة المودل
    onPageChanged: (index) {
      setState(() {
        if (index == 0) {
                ...
                color: selectedIndex == index
                  ...
                  Row(
                    children: [
                      Text(
                        widget.estate.name!,
                        style: AppTextStyle.locationName.copyWith(fontSize: 20,fontWeight: FontWeight.w800),
                      ),
                  ...
                  SizedBox(height: 28),
                  Text('Property Details', style: AppTextStyle.locationName.copyWith(fontWeight: FontWeight.bold)),
                  SizedBox(height: 16),
                 GridView.builder(
  shrinkWrap: true,
    ...
    return DetailsFeatureOfEstate(
      ...
      member: feature.icon != null
          ...
          : null,
                  ...
                  SizedBox(height: 24),
                  Text('Agent', style: AppTextStyle.locationName.copyWith(fontWeight: FontWeight.bold)),
                  SizedBox(height: 16),
                  Row(
                    children: [
                      Image.asset(
        ...
        'userAvatar': 'assets/image/person5.png',
                  ...
                  Text(
                    ...
                    style: AppTextStyle.locationName.copyWith(fontWeight: FontWeight.bold),
                  ),
                  SizedBox(height: 16),
                  SizedBox(
                    height: 30,
                  ...
                  Row(
                    children: [
                      Text('Reviews 152', style: AppTextStyle.locationName.copyWith(fontWeight: FontWeight.bold)),
                      Expanded(child: SizedBox()),
