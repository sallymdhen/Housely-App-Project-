...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  void _loadProfile() {
    _profileFuture = UserModel.getSavedUser().then(
      UserProfileModel.fromUserModel,
    );
  }
                  ...
                  child: Column(
                    children: [
                      ProfileAvatar(
                        ...
                        onCameraTap: () async {
                          // ✅ ننتظر الرجوع من Edit Profile، وبعدها نعيد تحميل البيانات
...
//       ),
//       body: FutureBuilder<UserProfileModel>(
//         future: UserModel.getSavedUser().then(UserProfileModel.fromUserModel),
//         builder: (context, snapshot) {
//           if (!snapshot.hasData) {
//             return const Center(child: CircularProgressIndicator());
//           }
